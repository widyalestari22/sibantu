    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Penyaluran Bantuan</li>
            </ol>
        </nav>
                                ...
                                @foreach ($penyaluran as $pen)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('pkh.penyaluran.destroy', ['id' => $pen->id_penyaluran]) }}"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="row g-3" action="{{ route('pkh.penyaluran.update', $pen->id_penyaluran) }}"
                                    method="POST">
                                    @csrf
            ...
            <div class="modal fade" id="modalTambah" tabindex="-1">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="row g-3" action="{{ route('pkh.penyaluran.store') }}" method="POST">
                                @csrf
