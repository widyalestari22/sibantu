...
@section('content')
    <div class="pagetitle">
        ...
        <a href="/staf/penyaluran/pkh/cetak" target="_blank"> <button type="button"
                class="btn btn-success rounded-pill">Cetak</button></a>
        <div class="card-body">
            <h5 class="card-title">Cetak Laporan</h5>
            <a href="/staf/penyaluran/pkh/cetak" target="_blank"> <button type="button" class="btn btn-success"><i
                        class="bi bi-check-circle"></i></button></a>
            <a href="/staf/penyaluranpkh/cetak/belum" target="_blank"><button type="button" class="btn btn-danger"><i
                            ...
                            <tbody>
                                @foreach ($penyaluran as $pen)
                                    <tr>
                                        ...
                                        <td>{{ \Carbon\Carbon::parse($pen->tanggal_penyaluran)->format('d-F-Y') }}</td>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('penyaluran.destroy.pkh', ['id' => $pen->id_penyaluran]) }}"
