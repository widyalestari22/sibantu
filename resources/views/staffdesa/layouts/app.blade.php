        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="/staf/penerimapkh/">
                            <i class="bi bi-circle"></i><span>Program Keluarga Harapan</span>
                        </a>
                    </li>
                    <li>
                        <a href="/staf/penerimaan">
                            <i class="bi bi-circle"></i><span>Bantuan Langsung Dana Desa</span>
                        </a>
                    </li>
            ...
            <li class="nav-item">
                ...
                <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="/staf/pengumuman">
                            <i class="bi bi-circle"></i><span>Pengumuman Penyaluran</span>
                        </a>
                    </li>
                    <li>
                        <a href="/staf/penyaluran/pkh">
                            <i class="bi bi-circle"></i><span>Program Keluarga Harapan</span>
                        </a>
                    </li>
                    <li>
                        <a href="/staf/penyaluran">
                            <i class="bi bi-circle"></i><span>Bantuan Langsung Dana Desa</span>
                        </a>
                    </li>
            ...
            <li class="nav-item">
                <a class="nav-link " href="/staf/persyaratan">
                    <i class="bi bi-file-ruled"></i>
                    <span>Persyaratan Pengajuan BLT DD</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link " href="/staf/pengguna">
